...
func runHeadlessSuite() -> Never {
    ...
    let verbs = ["opstest", "e2etest", "revealtest", "spawnlatency", "displaytest", "dragofftest", "extadopttest", "clamshelltest", "spacetest", "spacedetecttest", "movetest", "fullscreentest", "spacefocustest", "displaymovetest"]
    var failures = 0
    for verb in verbs {
        print("\n========== headless \(verb) ==========")
        let p = Process()
