...
func runHeadlessSuite() -> Never {
    ...
    let verbs = ["opstest", "e2etest", "revealtest", "hiddentest", "spawnlatency", "coldstarttest", "coldstartwarmtest", "coldstartbursttest", "coldstartflashheadless", "displaytest", "dragofftest", "extadopttest", "parktest", "exthotplugtest", "clamshelltest", "spacetest", "spacedetecttest", "movetest", "fullscreentest", "spacefocustest", "displaymovetest", "autotiletest", "statusicontest", "perspacetest", "perspacefallbacktest", "multidisplayperspacetest"]
    var failures = 0
    for verb in verbs {
        print("\n========== headless \(verb) ==========")
        let p = Process()
